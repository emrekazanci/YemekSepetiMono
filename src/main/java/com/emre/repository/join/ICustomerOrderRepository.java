...
public interface ICustomerOrderRepository extends JpaRepository<CustomerOrder,Long> {
    ...
    @Query(nativeQuery = true,value = "select c.customer_id,p.product_id,c.customer_name,p.product_name,p.cost,r.restaurant_name from tbl_customer as c\n" +
    ...
    List<CustomerOrder> orderForCustomer(Long customerId);
